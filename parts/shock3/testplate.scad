...
difference() {
    ...
    translate([0, -EPS, M_BOLT - M_INSET_START]) rotate([-90, 0, 0]) cylinder(h=100, d=4.0);   // fixme on bolt diameter
    ...
    translate([0, -EPS, M_SWITCH_CENTER - M_INSET_START]) rotate([-90, 0, 0]) cylinder(h=100, d=7.0); 
    hull() {
