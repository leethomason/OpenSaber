...
if (DRAW_FORE) 
{
    ...
    difference() {
        union() {
            ...
            intersection() 
            {
                translate([-50, -D_INNER/2, M_COPPER]) cube(size=[100, 5.0, H_HOLDER_1]);
        ...
        *translate([(DI_COPPER/2 - D_ROD/2), 0, M_COPPER - H_HOLDER_0 - H_NUT]) 
        ...
        // Access for rod nuts:
        translate([-50, -NUT_W/2, M_COPPER - H_HOLDER_0 - NUT_Y])
            cube(size=[100, NUT_W, NUT_Y]);
        translate([-50, -NUT_W/2 + 2, M_COPPER - H_HOLDER_0 - NUT_Y - 4])
            cube(size=[100, 4, NUT_Y + 4 + EPS]);
    ...
    difference() {
        ...
        translate([-STRIPSIZE/2, -4, M_COPPER - 1.5])
            cube(size=[STRIPSIZE, 100, 0.8]);
        translate([-WIRESIZE/2, 2.0, M_COPPER - H_HOLDER_0 - EPS])
            cube(size=[WIRESIZE, 100, 2.0]);            
