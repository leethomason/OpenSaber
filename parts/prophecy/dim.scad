TANO_VERSION		= 4;    // 4: etched v2, 5: blue v2

M_TRANSITION		= 101;
M_LED_HOLDER_FRONT	= M_TRANSITION + 62;
M_LED_HOLDER_BACK	= M_LED_HOLDER_FRONT - 10;
M_SWITCH_CENTER		= M_TRANSITION + 45;
M_DOTSTAR			= (TANO_VERSION == 4) ? M_TRANSITION + 34.4 : M_TRANSITION + 33;
M_PORT_CENTER       = (TANO_VERSION == 4) ? M_TRANSITION + 14.0 : M_TRANSITION + 13;
