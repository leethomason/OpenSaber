...
void calcCrystalColor(uint32_t t, int32_t variation, const uint8_t* base, uint8_t* out)
{
...
{
	const uint8_t base[3] = { 200, 200, 200 };
	uint8_t out[3];
	uint8_t maxVal[3] = { 0, 0, 0 };
	uint8_t minVal[3] = { 255, 255, 255 };
